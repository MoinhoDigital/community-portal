...
const marketSheet = `https://spreadsheets.google.com/feeds/cells/${
  process.env.MARKET_SHEET
...
module.exports = function(api) {
  api.loadSource(async (actions) => {
    ...
    addMetadata(
      "tileServer",
      process.env.TILE_SERVER || "mapbox://styles/mapbox/satellite-streets-v11"
    );
    ...
    try {
      ...
      console.error(err);
      const [lat, lon] = process.env.MAP_CENTER.split(',')
      collection.addNode({
        name: 'teste',
        category: 'teste',
